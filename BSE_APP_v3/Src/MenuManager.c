...
void Generate_Menu_Content(void){
	...
	Telium_Sprintf(var_MnuVoid,           "INSERT INTO AppMenus (MenuId, MenuName, MenuIdParent, Hidden, SecureMenu, SecureMenuLevel, DrCr, IconPathName) VALUES ('%d', 'Vo"
			""
			"id             ', '%d', '0','0' ,'1', 'C', 'file://flash/HOST/TU.TAR/icones/void.png');",           mnuVoid,mnuCustomer);                 // VOID
...
//	fncAutoSettlementChecker();
	...
	do{
		...
		MAPPUTSTR(appAppLoggedNamee, "----", lblKO);
