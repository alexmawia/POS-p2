...
//		{ appEthPort,            lenEthPort,           "7011" },                  // Port number
		...
		{ appMerchantName,       512,                   "Tracom App" },
		{ appHeader1,            512,                   "Academy at Work" },
		{ appHeader2,            512,                   "Nairobi Kenya" },
		{ appHeader3,            512,                   "" },
		{ appAppLoggedName,      128,                   "" },
		{ appAppLoggedNamee,      128,                   "Alex Mawia" },
...
//		{ appCurrCodeNumerc1,      4,                          "834" },
		...
		{ appCurrCodeAlpha1,       4,                          "KES" },
		{ appCurrCodeNumerc1,      4,                          "404" },
		{ appCurrExp1,             2,                          "2" },
